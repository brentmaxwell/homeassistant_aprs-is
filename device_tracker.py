...
CONF_SKIPLOGIN = "skip_login"

DEFAULT_HOST = "rotate.aprs2.net"
DEFAULT_PASSWORD = "-1"
DEFAULT_TIMEOUT = 30.0
DEFAULT_SKIPLOGIN = True
...
PLATFORM_SCHEMA = PLATFORM_SCHEMA.extend(
    {
        ...
        vol.Optional(CONF_SKIPLOGIN): cv.bool,
...
def setup_scanner(hass, config, see, discovery_info=None):
    ...
    skip_login = config.get(CONF_SKIPLOGIN)
...
class AprsListenerThread(threading.Thread):
    ...
    def __init__(
        self, callsign: str, password: str, skip_login: bool, host: str, server_filter: str, see
    ):
        ...
        self.ais = aprslib.IS(
            self.callsign, passwd=password, host=self.host, port=FILTER_PORT, skip_login = skip_login
        )
